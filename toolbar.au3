   ...
   If $sToggle = "Provisioning" Then ;Tasks
                  Switch $msg
                                ...
                                Case $button16 ;Notes Prep
                                                $string = 'var e="undefined"!=typeof g_form?window:document.getElementById("gsft_main").contentWindow;if("x_human_access_task"==e.g_form.tableName){var n=document.getElementById("sys_readonly.x_human_access_task.number").value,a=[],t=new e.GlideRecord("x_human_access_task");if(t.addQuery("sys_id",e.g_form.getUniqueValue()),t.query(),t.next()){var s=new e.GlideRecord("x_human_access_request");if(s.addQuery("sys_id",t.parent),s.query(),s.next()){var r=new e.GlideRecord("sys_user"),u="^sys_idIN"+s.getValue("opened_for");for(""!==s.getValue("receivers")&&(u+=","+s.getValue("receivers")),u+="^EQ",r.encodedQuery=u,r.query();r.next();)a.push(r.getValue("user_name")+";"+(r.getValue("u_nickname")||r.getValue("first_name"))+";"+r.getValue("last_name")+";"+r.getValue("email")+";"+n)}var d="";d=a.length>0?a.map(function(e){return""+e}).join("<br>")+"<br>":"",e.g_form.addInfoMessage(d)}}else alert("This can only be used on ART tickets");'
                                                MainApp("", $string)
                                Case $button17
                                                $string = $jsMainApp & 'MainAppWin.g_form.setValue("short_description","Grant access - SQL");var text=MainAppWin.g_form.getValue("description"),nth=0;text=text.replace(/(?:\r\n|\r|\n)/g,"; "),text=text.replace(/Database Name:/g,"\nDatabase:").replace(/User Name:/g,"\n\nUser Name:").replace(/SQL Server Name:/g,"\nSQL Server:").replace(/User ID:/g,"\nUser ID:").replace(/Telephone #:/g,"\nTelephone #:").replace(/Access Needed \/ Role:/g,"\nRole:").replace(/Reason Access is Needed:/g,"\nReason:").replace(/Name of Special Role\(s\):/g,"\nSpecial Role(s):").replace(/Special Requirements:; \(default is domain or HMHSChamp\)/g,"\nSpecial Requirements:").replace(/\*Special application\/system  Account ID /g,"\nSpecial application or ID: ").replace(/\*Account Owner ID /g,"\nAccount Owner ID: ").replace(/Active Directory; Group Name:/g,"\nGroup Name:").replace(/;\s{1,};/g,"").replace(/1\s{1,}DataReader\; {1,}/g,"DataReader;  ").replace(/0\s{1,}DataReader\; {1,}/g,"").replace(/1\s{1,}DataWriter\; {1,}/g,"DataWriter; ").replace(/0\s{1,}DataWriter\; {1,}/g,"").replace(/1\s{1,}SP_Execute\; {1,}/g,"SP_Execute; ").replace(/0\s{1,}SP_Execute\; {1,}/g,"").replace(/1\s{1,}Other/g,"Other").replace(/0\s{1,}Other {1,}/g,"").replace(/0\s{1,}New\; {1,}/g,"").replace(/1\s{1,}New\; {1,}/g,"New; ").replace(/0\s{1,}Existing/g,"").replace(/1\s{1,}Existing/g,"Existing; ").replace(/[(]{0,1}[0-9]{3}[)]{0,1}[-\s{1,}\.]{0,1}[0-9]{3}[-\s{1,}\.]{0,1}[0-9]{4}/g,"").replace(/Telephone #:\s{0,}; {1,}\n/g,"").replace(/Special Role\(s\): {1,}; {1,}\n/g,"").replace(/Special Requirements: {1,}\n/g,"").replace(/\(required for special accounts\)\:\s{1,}/g,"\n").replace(/;\s{1,}Reason:/g,"\nReason:").replace(/\(if applicable\)\: {1,}/g,"\n").replace(/^;\s{1,}\n\n/g,"").replace(/;\s\n/g,"\n").replace(/Telephone #:\s{1,}\n/g,"\n").replace(/:\s{1,}\n/g,":        \n").replace(/.*\:        \n/g,"").replace(/; {1,}\n/g,"").replace(/User Name\:/g,function(e,a,r){return nth++,nth>1?"\n\nUser Name:":e}),MainAppWin.g_form.setValue("description",text);'
                                                $oIE = MainApp("", $string)
                                                FormatSQL($oIE)
                                Case $button18 ;Format AD
                                                $string = '!function(){var e="undefined"!=typeof g_form?window:document.getElementById("gsft_main").contentWindow,r=e.g_form.getValue("short_description"),n="Domain group membership";if(null!==r.match("Urgent Request: Virtual Training Room Access")&&(n=r),"x_human_access_request"==e.g_form.getTableName()||"x_human_access_task"==e.g_form.getTableName()){var t="x_human_access_request"==e.g_form.getTableName()?e.g_form.getValue("receiver_ids").split(/,/):e.g_form.getValue("x_human_access_task.parent.ref_x_human_access_request.receiver_ids").split(/,/),s=[],a=e.g_form.getValue("description").match(/(G_.*)/gi);if(0===t.length)e.g_form.addErrorMessage("Error: No receivers were listed");else{var o=new e.GlideRecord("sys_user");for(o.addQuery("user_name","IN",t.join(",")),o.query();o.next();)s.push(o.getValue("user_name")+" ("+(""!==o.getValue("u_nickname")?o.getValue("u_nickname"):o.getValue("first_name"))+" "+o.getValue("last_name")+")")}0===a.length?(a.push("G_TS_Remote_Desktop_Connection"),e.g_form.addErrorMessage("Error: Unable to find groups (G_*)")):a.map(function(e){return e.trim()}),e.g_form.setValue("short_description",n),e.g_form.setValue("description","Grant the following domain group membership:\n- User IDs:\n  - "+s.join("\n  - ")+"\n- Groups:\n  - "+a.join("\n  - ")+"\n\n--- Original request below ---\n\n"+e.g_form.getValue("description"))}else alert("This can only be used on AR or ARTASK tickets")}();'
                                                MainApp("", $string)
                                Case $button19
                                                $oIE = GetIe()
   ...
   ElseIf $sToggle = "Research" Then ;Research
                  Switch $msg
                                ...
                                Case $button9;Format Unix
                                                $string = $jsMainApp & 'MainAppWin.g_form.setValue("short_description","Grant access - Unix");var text=MainAppWin.g_form.getValue("description");text=text.replace(/\n\n/g,"\n").replace(/\? Yes or No\?/g,":").replace(/If “Yes”, |If “No”, | \(Mark One\)/g,"").replace(/IF desired group is not listed, please specify:/g,"Specify group:").replace(/Develop:\s{0,}X/g,"Develop ").replace(/DBA:\s{0,}X/g,"DBA ").replace(/SYSADMIN:\s{0,}X/g,"SYSADMIN").replace(/Develop:/g,"").replace(/DBA:/g,"").replace(/SYSADMIN:/g,"").replace(/,\s{0,}/g,"\n                                ").replace(/[(]{0,1}[0-9]{3}[)]{0,1}[-\s{1,}\.]{0,1}[0-9]{3}[-\s{1,}\.]{0,1}[0-9]{4}/g,"").replace(/Phone Number:\t{0,}\n/g,"").replace(/Unix Server\s{1,}:/g,"Unix Server:").replace(/Humana Employee:.*\n/g,"").replace(/Vendor Name:.*\n/g,"").replace(/5-Digit Facility ID:.*\n/g,""),MainAppWin.g_form.setValue("description",text);'
                                                $sToggle = "Provisioning"
                                                MainApp("", $string)
                                                $sToggle = "Research"
                                                Flip()
                                Case $button10 ;Contractor Email
                                                $string = '!function(){var e="undefined"!=typeof g_form?window:document.getElementById("gsft_main").contentWindow;if("x_human_access_task"==e.g_form.tableName){var n=[],r=new e.GlideRecord("x_human_access_task");if(r.addQuery("sys_id",e.g_form.getUniqueValue()),r.query(),r.next()){var t=new e.GlideRecord("x_human_access_request");if(t.addQuery("sys_id",r.parent),t.query(),t.next()){var a=new e.GlideRecord("sys_user"),s="^sys_idIN"+t.getValue("opened_for");for(""!=t.getValue("receivers")&&(s+=","+t.getValue("receivers")),s+="^EQ",a.encodedQuery=s,a.query();a.next();)n.push(a.getValue("user_name")+" ("+(a.getValue("u_nickname")||a.getValue("first_name"))+" "+a.getValue("last_name")+")")}n.length>0?e.g_form.setValue("description","Receivers:\n"+n.map(function(e){return"- "+e}).join("\n")+"\n\n"+e.g_form.getValue("description")):e.g_form.setValue("description","Receivers:\n- None\n\n"+e.g_form.getValue("description"))}}else alert("This can only be used on ART tickets")}();'
                                                MainApp("", $string)
                                ...
                                Case $button14; Copy Receivers
                                                $string = '!function(){var e="undefined"!=typeof g_form?window:document.getElementById("gsft_main").contentWindow;if("x_human_access_task"==e.g_form.tableName){var n=[],a=new e.GlideRecord("x_human_access_task");if(a.addQuery("sys_id",e.g_form.getUniqueValue()),a.query(),a.next()){var r=new e.GlideRecord("x_human_access_request");if(r.addQuery("sys_id",a.parent),r.query(),r.next()){var t=new e.GlideRecord("sys_user"),s="^sys_idIN"+r.getValue("opened_for");for(""!=r.getValue("receivers")&&(s+=","+r.getValue("receivers")),s+="^EQ",t.encodedQuery=s,t.query();t.next();)n.push(t.getValue("user_name")+" ("+(t.getValue("u_nickname")||t.getValue("first_name"))+" "+t.getValue("last_name")+")")}n.length>0?e.g_form.setValue("description","Receivers:\n"+n.map(function(e){return"- "+e}).join("\n")+"\n\n"+e.g_form.getValue("description")):e.g_form.setValue("description","Receivers:\n- None\n\n"+e.g_form.getValue("description"))}}else alert("This can only be used on ART tickets")}();'
                                                MainApp("", $string)
                                ...
                                Case $button19; Shrink
                                                $string = $jsMainApp & "var text = MainAppWin.g_form.getValue('description');text = text.replace(/\n\n/g,'\n');MainAppWin.g_form.setValue('description',text);"
                                                MainApp("", $string)
                                Case $button20; New Lines
                                                $string = $jsMainApp & "var text = MainAppWin.g_form.getValue('description');text = text.replace(/,|;/g,'\n');MainAppWin.g_form.setValue('description',text);"
                                                MainApp("", $string)
                                Case $button21; Add Tabs
                                                $string = $jsMainApp & "var text = MainAppWin.g_form.getValue('description');text = text.replace(/\t/g,'\t\t\t\t\t\t');MainAppWin.g_form.setValue('description',text);"
                                                MainApp("", $string)
   ...
   ElseIf $sToggle = "Email" Then ;Email
                  ...
                  Switch $msg
                                ...
                                Case $button12
                                                ...
                                                $to = "Rod or Greg"
                                                $address = 'rkahl@humana.com;gfarr@humana.com'
                                                MainApp("", $string, $to, $address)
                                Case $button13
...
Func AppDB($oIE)
   Local $desc, $flag, $lookup, $systemMSG, $desc2, $descClean, $array, $group, $replaceString, $results, $row = ""
   ...
   ElseIf $flag = "AD" Then
                  ...
                  For $i = 0 To UBound($group) - 1
                                If $i <> 0 Then
                                                $lookup = $lookup & ","
                                EndIf
                                $lookup = $lookup & "'Active Directory/PROD/GROUP/domain.com\" & $group[$i] & "'"
                  Next
   ...
   #Region Connect to SQL and retreive records.
   Local $conn = ObjCreate("ADODB.Connection")
   Local $RS = ObjCreate("ADODB.Recordset")
   Local $DSN = "Provider=SQLOLEDB;Data Source=server;Initial Catalog=AccessApprovers;Integrated Security=SSPI;"
   $conn.Open($DSN)
   ...
   If IsArray($array) Then
                  ...
                  _ArrayDisplay($results, "Results", Default, 64, Default, Default, Default, 0xe6e8ea)
                  If $systemMSG[0][0] <> Null Then MsgBox(0,"System Message",$systemMSG[0][0])
                  #EndRegion


                  #Region Clean up string and replace with approver data
                  If $sToggle = "Provisioning" Then
                                For $i = 1 To UBound($results) - 1
                                                ...
                                                ElseIf $flag = "AD" Then
                                                   $replaceString  = StringReplace($results[$i][0],"Active Directory/PROD/GROUP/domain.com\","")
                                                ElseIf $flag = "SQL" Then
                                                ...
                                                If $results[$i][7] = "Approved" Then
                                                   $desc = StringReplace($desc,$replaceString,$replaceString & " (" & $requestor & ")" & $results[$i][7], 1)
...
Func CheckSQLDB($arg1, $arg2, $arg3)
   Local $conn = ObjCreate("ADODB.Connection")
   Local $RS = ObjCreate("ADODB.Recordset")
...
Func DB($results, $aSelected)
   Local $systemMSG = "Active Directory"
   ...
   If IsArray($array) Then
                  Local $appResults[1][7]
                  $appResults[0][0] = "Group"
                  $appResults[0][1] = "Description"
                  $appResults[0][2] = "Business Description"
                  $appResults[0][3] = "Primary"
                  $appResults[0][4] = "BackUp"
                  $appResults[0][5] = "Steward"
                  $appResults[0][6] = "Seconday"

                  $row = UBound($appResults) - 1

                  #Region Flatten results
                  For $i = 0 To UBound($array) - 1
                                If $appResults[$row][0] <> $array[$i][0] Then
                                                ReDim $appResults[UBound($appResults) + 1][7]
                                EndIf
                                $row = UBound($appResults) - 1
                                If $array[$i][2] <> 2 Then
                                                $appResults[$row][0] = $array[$i][0]
                                                If $array[$i][1] <> Null And $appResults[$row][1] <> Null And $array[$i][1] <> "" And $appResults[$row][1] <> "" Then
                                                   $appResults[$row][1] = $appResults[$row][1] & "; " & $array[$i][1]
                                                Elseif $array[$i][1] <> Null And $array[$i][1] <> "" Then
                                                   $appResults[$row][1] = $array[$i][1]
                                                EndIf
                                                If $array[$i][2] = 1 Then
                                                   If $array[$i][4] <> Null And $appResults[$row][2] <> Null And $array[$i][4] <> "" And $appResults[$row][2] <> "" Then
                                                                  $appResults[$row][2] = $appResults[$row][2] & "; " & $array[$i][4]
                                                   Elseif $array[$i][4] <> Null And $array[$i][4] <> "" Then
                                                                  $appResults[$row][2] = $array[$i][4]
                                                   EndIf
                                                   If $array[$i][5] <> Null And $appResults[$row][3] <> Null And $array[$i][5] <> "" And $appResults[$row][3] <> "" Then
                                                                  $appResults[$row][3] = $appResults[$row][3] & "; " & $array[$i][5]
                                                   Elseif $array[$i][5] <> Null And $array[$i][5] <> "" Then
                                                                  $appResults[$row][3] = $array[$i][5]
                                                   EndIf
                                                   If $array[$i][6] <> Null And $appResults[$row][4] <> Null And $array[$i][6] <> "" And $appResults[$row][4] <> "" Then
                                                                  $appResults[$row][4] = $appResults[$row][4] & "; " & $array[$i][6]
                                                   Elseif $array[$i][6] <> Null And $array[$i][6] <> ""  Then
                                                                  $appResults[$row][4] = $array[$i][6]
                                                   EndIf
                                                   If $array[$i][7] <> Null And $appResults[$row][5] <> Null And $array[$i][7] <> "" And $appResults[$row][5] <> "" Then
                                                                  $appResults[$row][5] = $appResults[$row][5] & "; " & $array[$i][7]
                                                   Elseif $array[$i][7] <> Null And $array[$i][7] <> ""  Then
                                                                  $appResults[$row][5] = $array[$i][7]
                                                   EndIf
                                                EndIf
                                                If $array[$i][8] = 0 Then
                                                   $appResults[$row][3] = "Manager Only"
                                                EndIf
                                EndIf
                                If $array[$i][2] = 2 Then
                                                If $array[$i][6] <> Null And $appResults[$row][6] <> Null And $array[$i][6] <> "" And $appResults[$row][6] <> "" Then
                                                   $appResults[$row][6] = $appResults[$row][6] & "; " & $array[$i][5]
                                                Else
                                                   $appResults[$row][6] = $array[$i][5]
                                                EndIf
                                EndIf
                  Next
                  #EndRegion
                  ...
                  #Region Display System Message if one exists
                  _ArrayDisplay($appResults, "Results", Default, 64, Default, Default, Default, 0xe6e8ea)
                  If $systemMSG[0][0] <> Null Then MsgBox(0,"System Message",$systemMSG[0][0])
                  #EndRegion
   EndIf
EndFunc
...
Func DrawGUI()
   If @DesktopWidth > 1920 Then
                  Local $width = (@DesktopWidth / 2) - 132
   Else
                  Local $width = @DesktopWidth - 132
   EndIf

   $hGui = GUICreate("ToolBar", 122, $iHeight, $width, 234, -1, $WS_EX_TOPMOST)
...
Func GetAclByCacls ($FilePath)
   Local $CaclsPath = @SystemDir & "\ICACLS.exe"
   Local $Run = FileGetShortName ( $CaclsPath ) & ' "' & $FilePath & '" '
   Local $Pid = Run ( $Run, '', @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
   ProcessWaitClose($Pid)
   Local $message = StdoutRead($Pid)
   Return $message
...
Func GetSetValues($oIE, $arg1, $arg2 = "")
...
Func ManagerLookUp()
   ...
   Local $query = "select 'TSOID' as TSOID " & _
                                                  ...
                                                  "FROM [AccessApprovers].[dbo].[tbl_PersonnelAll] as assoc " & _
                                                  "join [AccessApprovers].[dbo].[tbl_PersonnelAll] as manager " & _
                                                  "on assoc.[SupervisorFullName] = manager.[FullName] " & _
                                                  "join [AccessApprovers].[dbo].[tbl_PersonnelAll] as nextmanager " & _
                                                  "on manager.[SupervisorFullName] = nextmanager.[FullName] " & _
...
Func ReceiverList($oIE, $arg = True)
   Local $desc = GetSetValues($oIE, "description")
